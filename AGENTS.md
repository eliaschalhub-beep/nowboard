...
- **Job:** GitHub Actions `.github/workflows/nowboard-run.yml` at 06:30 and 18:30 UTC, following `nowboard-run.md` — Reminders, key dates, holidays, sport, weather and travel, then render.
